...
model_presets = {
    'gpt2': {'10m': GPTConfig(n_layer=2, n_head=2, n_embd=64, vocab_size=50304, block_size=1024),
             '124m': GPTConfig(n_layer=12, n_head=12, n_embd=768, vocab_size=50257, block_size=1024),
    ...
    'llama': {'124m': LlamaConfig(n_layers=12, n_heads=12, dim=768, vocab_size=50304, max_seq_len=1024, intermediate_size=4 * 768),
              ...
              '2b': LlamaConfig(n_layers=36, n_heads=32, dim=2304, vocab_size=50304, max_seq_len=1024, intermediate_size=5120,n_kv_heads=8)},

    'gpt2variant': {'10m': GPTVariantConfig(n_layer=2, n_head=2, n_embd=64, vocab_size=50304, block_size=1024),
             '124m': GPTVariantConfig(n_layer=12, n_head=12, n_embd=768, vocab_size=50257, block_size=1024),
